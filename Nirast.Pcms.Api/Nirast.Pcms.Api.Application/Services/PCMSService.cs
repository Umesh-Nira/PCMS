    ...
    public class PCMSService : IPCMSService
    {
        ...
        private async Task SendEmailTOAdminAndOfficeAfterCaretakerReg(CareTakerRegistrationModel caretaker)
        {
            EmailInput inputs = new EmailInput
            {
                ...
                EmailIdConfig = _unitOfWork.UsersDetailsRepository.GetEmailIdConfigByType(EmailType.Registration).Result,
        ...
        public async Task<LoggedInUser> CheckLoginCredentials(UserCredential userCredential)
        {
        ...
        public async Task<EmailTypeConfiguration> GetEmailIdConfigByType(EmailType emailType)
        {
            return await _unitOfWork.UsersDetailsRepository.GetEmailIdConfigByType(emailType);
        }
