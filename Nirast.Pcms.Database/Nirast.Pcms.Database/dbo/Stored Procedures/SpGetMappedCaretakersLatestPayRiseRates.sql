CREATE PROCEDURE [dbo].[SpGetMappedCaretakersLatestPayRiseRates] 
	(
	@ClientId int,
	@CaretakerId int
	)
...
BEGIN
	...
	SELECT @LatestDate = MAX([PayriseDate]) FROM [dbo].[Caretaker_Payroll_Payrise] WHERE [CaretakerId]=@CaretakerId AND [ClientId]=@ClientId
