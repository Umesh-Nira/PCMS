    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult ManageCaretaker()
        {
            ...
            try
            {
                ...
                string manageCaretaker = "Admin/SelectCaretakersByCaretakerStatus/" + (int)CaretakerStatus.Approved;
                var countryResult = service.GetAPI(manageCaretaker);
                caretakers = JsonConvert.DeserializeObject<List<CareTakerRegistrationViewModel>>(countryResult);
        ...
        public ActionResult AppliedCaretakers()
        {
            ...
            try
            {
                ...
                api = "Admin/SelectCaretakersByCaretakerStatus/" + (int)CaretakerStatus.Applied;
        ...
        public ActionResult ManageOfficeStaff()
        {
            ...
            try
            {
                ...
                api = "Admin/GetAllOfficeStaffDetails";
                var result = service.GetAPI(api);
        ...
        public ActionResult CareTakerList()
        {
            ...
            try
            {
                string api = "Admin/SelectCaretakers/" + (int)CaretakerStatus.Applied;
                var result = service.GetAPI(api);
                caretakerList = JsonConvert.DeserializeObject<List<CareTakerRegistrationViewModel>>(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult SendClentEmail(string clientname, string email, int fileId)
        {
            try
            {
                Service service = new Service();
        ...
        public ActionResult BookingNotification()
        {
            ...
            try
            {
                string api = "Admin/GetAdminNotification";
                var result = service.GetAPI(api);
                notifications = Newtonsoft.Json.JsonConvert.DeserializeObject<List<AdminBookingNotification>>(result);
        ...
        public ActionResult NewBooking()
        {
            ...
            try
            {
                string api = "Admin/GetAdminBookingList";
                var result = service.GetAPI(api);
                bookingList = Newtonsoft.Json.JsonConvert.DeserializeObject<List<AdminBookingList>>(result);
